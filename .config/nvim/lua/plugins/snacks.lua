...
return {
	...
	keys = {
		...
		{ '<leader>fp', function() Snacks.picker.projects({ layout = 'select' }) end, desc = '[P]rojects' },
		...
		{ '<leader>fG', function() Snacks.picker.grep({ cwd = '~' }) end, desc = '[G]rep (Home)' },
		{ '<leader>fs', function() Snacks.picker.grep_word() end, desc = '[G]rep Selection (cwd)' },
		{ '<leader>fS', function() Snacks.picker.grep_word({ cwd = '~' }) end, desc = '[G]rep Selection (Home)' },
...
d88'   88b  `?888P'  `?8888P'  `?888P'  d88' d88' d88'  88b]],
				keys = {
					...
					{ icon = " ", key = "p", desc = "[P]rojects", action = "<leader>fp" },
					{ icon = " ", key = "e", desc = "[E]xplore Files", action = "<leader>fe" },
					{ icon = " ", key = "f", desc = "[F]ind Files", action = "<leader>ff" },
					{ icon = " ", key = "r", desc = "[R]ecent Files", action = "<leader>fr" },
					{ icon = " ", key = "c", desc = "[C]onfig Files", action = "<leader>fc" },
